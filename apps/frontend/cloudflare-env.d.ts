/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: e2ab75669ff577c80483dd7705f6398e)
// Runtime types generated with workerd@1.20251118.0 2025-11-23 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./.open-next/worker");
	}
	interface Env {
		NEXT_PUBLIC_WORKER_URL: "http://localhost:8787" | "https://rawg-analytics-worker.your-subdomain.workers.dev";
		BACKEND: Fetcher /* rawg-analytics-worker */;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_WORKER_URL">> {}
}
